...
plt.xlabel("Género")
plt.ylabel("Cantidad")
plt.savefig("personas_por_genero.png")
plt.close()
...
plt.xlabel("Cantidad")
plt.ylabel("País")
plt.savefig("personas_por_pais.png")
plt.close()
...
plt.ylabel("País")
plt.savefig("edad_promedio_por_pais.png")
plt.close()

# Top 3 países con más personas
sns.plot(kind='bar', color='orange')
plt.title("Top 3 países con más personas")
plt.ylabel("Cantidad")
plt.savefig("top3_paises.png")
plt.close()
